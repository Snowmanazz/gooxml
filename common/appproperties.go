...
import (
	...
	"github.com/Snowmanazz/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/Snowmanazz/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/Snowmanazz/gooxml
