...
type WdCT_WordprocessingShapeWps struct {
...
func NewWdCT_WordprocessingShapeWps() *WdCT_WordprocessingShapeWps {
	ret := &WdCT_WordprocessingShapeWps{}
...
func (m *WdCT_WordprocessingShapeWps) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	e.EncodeToken(start)
	if m.CNvPr != nil {
		secNvPr := xml.StartElement{Name: xml.Name{Local: "wps:cNvPr"}}
		e.EncodeElement(m.CNvPr, secNvPr)
	}
	m.Choice.MarshalXML(e, xml.StartElement{})
	sespPr := xml.StartElement{Name: xml.Name{Local: "wps:spPr"}}
	e.EncodeElement(m.SpPr, sespPr)
	if m.Style != nil {
		sestyle := xml.StartElement{Name: xml.Name{Local: "wps:style"}}
		e.EncodeElement(m.Style, sestyle)
	}
	if m.ExtLst != nil {
		seextLst := xml.StartElement{Name: xml.Name{Local: "wps:extLst"}}
		e.EncodeElement(m.ExtLst, seextLst)
	}
	if m.WChoice != nil {
		m.WChoice.MarshalXML(e, xml.StartElement{})
	}
	sebodyPr := xml.StartElement{Name: xml.Name{Local: "wps:bodyPr"}}
	e.EncodeElement(m.BodyPr, sebodyPr)
	e.EncodeToken(xml.EndElement{Name: start.Name})
	return nil
}

func (m *WdCT_WordprocessingShapeWps) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "cNvPr"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "cNvPr"}:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "cNvSpPr"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "cNvSpPr"}:
				m.Choice = NewWdCT_WordprocessingShapeChoice()
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "cNvCnPr"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "cNvCnPr"}:
				m.Choice = NewWdCT_WordprocessingShapeChoice()
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "spPr"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "spPr"}:
				if err := d.DecodeElement(m.SpPr, &el); err != nil {
					return err
				}
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "style"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "style"}:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "extLst"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "extLst"}:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "txbx"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "txbx"}:
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "linkedTxbx"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "linkedTxbx"}:
				m.WChoice = NewWdCT_WordprocessingShapeChoice1()
			...
			case xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing", Local: "bodyPr"},
				xml.Name{Space: "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingShape", Local: "bodyPr"}:
...
func (m *WdCT_WordprocessingShapeWps) Validate() error {
	return m.ValidateWithPath("WdCT_WordprocessingShapeWps")
}

// ValidateWithPath validates the WdCT_WordprocessingShape and its children, prefixing error messages with path
func (m *WdCT_WordprocessingShapeWps) ValidateWithPath(path string) error {
	if m.CNvPr != nil {
